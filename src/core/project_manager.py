...
from .ai_interface import AIInterface, AIContext, TaskComplexityAnalyzer
from .config_manager import ConfigManager
from .task_engine import TaskEngine, ExecutionStrategy, create_task
from .types import (
...
class ProjectManager:
    ...
    async def orchestrate_development(
        ...
        try:
            ...
            result = await self.task_engine.execute_workflow(workflow, strategy)
