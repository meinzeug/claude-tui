...
import pydantic
from src.claude_tui.utils.pydantic_compat import BaseModel, Field, field_validator
...
class TaskException(ClaudeTUIException):
    """Task-related exceptions."""
    pass


class WorkflowException(ClaudeTUIException):
    """Workflow-related exceptions."""
    pass


class ValidationException(ClaudeTUIException):
