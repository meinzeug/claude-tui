...
from src.api.v1 import projects, tasks, validation, ai, community, ai_advanced, workflows, analytics, websocket, production_validation
from src.api.middleware.security import SecurityMiddleware
from src.api.middleware.logging import LoggingMiddleware
from src.api.middleware.caching import setup_cache_middleware
from src.api.middleware.compression import setup_compression_middleware
from src.api.dependencies.database import get_database
from src.api.models.base import init_database
...
def create_app() -> FastAPI:
    ...
    app.include_router(production_validation.router, prefix="/api/v1", tags=["Production Validation"])
    
    # High-Performance Endpoints
    from src.api.v1 import performance
