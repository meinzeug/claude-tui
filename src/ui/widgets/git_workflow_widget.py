...
# Note: Git integrations temporarily disabled for testing
# from claude_tui.integrations.git_advanced import (
#     EnhancedGitManager, PullRequest, CodeReview, BranchRule,
#     PRStatus, ReviewStatus, CIStatus
# )
# from claude_tui.core.types import ValidationResult
