...
@router.get("/collections", response_model=List[FeaturedCollectionResponse])
...
@router.post("/collections", response_model=FeaturedCollectionResponse)
...
@router.get("/collections/{collection_id}", response_model=FeaturedCollectionResponse)
...
@router.put("/collections/{collection_id}", response_model=FeaturedCollectionResponse)
