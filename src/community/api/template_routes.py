...
@template_router.post("/", response_model=TemplateResponse)
...
@template_router.post("/inherit", response_model=TemplateResponse)
...
@template_router.post("/{template_id}/build", response_model=TemplateBuildResult)
...
@template_router.post("/{template_id}/validate-build")
...
@template_router.get("/{template_id}/stats")
...
@template_router.get("/{template_id}/versions")
...
@template_router.get("/slug/{slug}", response_model=TemplateResponse)
