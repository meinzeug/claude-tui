...
from claude_tiu.core.logger import get_logger
from claude_tiu.ui.screens.workspace_screen import WorkspaceScreen
from claude_tiu.ui.screens.project_wizard import ProjectWizard
...
from claude_tiu.ui.widgets.metrics_dashboard import MetricsDashboard
...
class ClaudeTIUApp(App):
    ...
    TITLE = "Claude TIU - AI-Powered Development Environment"
    ...
    def __init__(
        ...
        logger.info("Claude TIU App initialized")
    ...
    async def on_mount(self) -> None:
        ...
        logger.info("Claude TIU App mounted")
    ...
    async def _initialize_components(self) -> None:
        ...
        try:
            self.notify("Initializing Claude TIU...", severity="info")
            ...
            self.notify("Claude TIU ready!", severity="success")
    ...
    async def close_application(self) -> None:
        ...
        try:
            self.notify("Shutting down Claude TIU...", severity="info")
