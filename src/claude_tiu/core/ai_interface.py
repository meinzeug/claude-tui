...
from claude_tiu.models.ai_models import (
    CodeContext, CodeResult, ReviewCriteria, CodeReview,
    ValidationResult, PlaceholderDetection, TaskRequest, TaskResult
)
from claude_tiu.core.config_manager import ConfigManager
from claude_tiu.core.exceptions import AIInterfaceError, ValidationError
...
class AIInterface:
    """
    High-level AI interface for Claude TIU operations.
