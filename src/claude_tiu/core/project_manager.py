...
from claude_tiu.utils.template_engine import TemplateEngine
from claude_tiu.utils.file_system import FileSystemManager
...
class ProjectManager:
    ...
    def __init__(
        ...
        self.state_manager = state_manager or StateManager(config_manager)
