#!/usr/bin/env python3
"""
Claude-TIU Workspace Management CLI Commands.
...
def create(
    ...
    Examples:
        claude-tiu workspace create my-company
        claude-tiu workspace create web-projects --template=web-workspace
        claude-tiu workspace create --path=/custom/path my-workspace
    """
...
def list(ctx: click.Context, format: str, detailed: bool) -> None:
    ...
    Examples:
        claude-tiu workspace list
        claude-tiu workspace list --format=tree --detailed
    """
...
def switch(ctx: click.Context, workspace_name: str) -> None:
    ...
    Examples:
        ...
        claude-tiu workspace switch web-projects
    """
...
def remove(
    ...
    Examples:
        claude-tiu workspace remove old-workspace --backup
        claude-tiu workspace remove temp-workspace --force
    """
...
def clone(
    ...
    Examples:
        claude-tiu workspace clone production staging
        claude-tiu workspace clone web-workspace new-web-workspace --include-projects
    """
...
def add(
    ...
    Examples:
        claude-tiu workspace template add ./my-template --name=custom-api
        claude-tiu workspace template add ./react-starter --category=frontend
    """
...
def set(
    ...
    Examples:
        claude-tiu workspace config set ai.model claude-3
        claude-tiu workspace config set --global default.template web-app
