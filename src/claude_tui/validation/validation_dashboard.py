...
class ValidationDashboard:
    ...
    def _export_to_prometheus(self, dashboard_data: DashboardData) -> str:
        ...
        metrics.append(f"# HELP claude_tui_validations_total Total number of validations")
        metrics.append(f"# TYPE claude_tui_validations_total counter")
        metrics.append(f"claude_tui_validations_total {dashboard_data.validation_metrics.total_validations}")
        
        metrics.append(f"# HELP claude_tui_response_time_ms Average response time in milliseconds")
        metrics.append(f"# TYPE claude_tui_response_time_ms gauge")
        metrics.append(f"claude_tui_response_time_ms {dashboard_data.performance_metrics.p95_response_time_ms}")
