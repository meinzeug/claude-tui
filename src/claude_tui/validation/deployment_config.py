...
class ProductionDeploymentConfig:
    ...
    # Deployment paths
    data_path: Path = Path("/opt/claude-tui/data")
    logs_path: Path = Path("/opt/claude-tui/logs")
    models_path: Path = Path("/opt/claude-tui/models")
    cache_path: Path = Path("/opt/claude-tui/cache")
