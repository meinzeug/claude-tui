...
from src.claude_tui.utils.dependency_resolver import DependencyResolver
from src.claude_tui.utils.metrics_collector import MetricsCollector
...
class TaskEngine:
    ...
    async def execute_workflow_from_file(
        ...
        """
        try:
            from src.claude_tui.utils.workflow_loader import WorkflowLoader
