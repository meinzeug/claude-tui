    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(classes="help-container"):
            ...
            with Horizontal(classes="help-header"):
                yield Label("📚 Claude TUI Help & Documentation", classes="help-title")
...
## Welcome!
Claude TUI is an AI-powered Terminal User Interface that enhances your development workflow with intelligent assistance, project management, and automated tasks.
...
- Let Claude TUI set up your development environment
...
### Q: How do I update Claude TUI?
A: Use pip to update: `pip install --upgrade claude-tui`

### Q: Can I use Claude TUI offline?
A: Basic features work offline, but AI requires internet connection

### Q: How do I backup my configuration?
A: Configuration is stored in `~/.claude-tui/config.yaml`
...
Claude TUI (Terminal User Interface) is an intelligent AI-powered development environment that combines the power of artificial intelligence with sophisticated terminal interfaces for enhanced software development workflows.
...
- **Documentation**: https://claude-tui.readthedocs.io
- **GitHub**: https://github.com/claude-tui/claude-tui
- **Issues**: https://github.com/claude-tui/claude-tui/issues
- **Discussions**: https://github.com/claude-tui/claude-tui/discussions
...
*Built with ❤️ by the Claude TUI team*
"""
