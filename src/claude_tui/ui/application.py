...
try:
    from src.claude_tui.ui.screens import (
...
try:
    ...
    from src.claude_tui.ui.widgets.placeholder_alert import PlaceholderAlert
    from src.claude_tui.ui.widgets.progress_intelligence import ProgressIntelligence
    from src.claude_tui.ui.widgets.workflow_visualizer import WorkflowVisualizerWidget
    from src.claude_tui.ui.widgets.metrics_dashboard import MetricsDashboardWidget
    from src.claude_tui.ui.widgets.modal_dialogs import ConfigurationModal, CommandTemplatesModal
except ImportError:
...
try:
    from src.claude_tui.utils.theme_manager import ThemeManager
except ImportError:
...
class ClaudeTUIApp(App):
    ...
    async def action_open_project(self) -> None:
        ...
        """
        from src.claude_tui.ui.screens.project_browser_screen import ProjectBrowserScreen
    ...
    async def action_settings(self) -> None:
        ...
        """
        from src.claude_tui.ui.screens.settings_screen import SettingsScreen
