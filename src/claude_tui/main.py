...
try:
    ...
    # Import from the actual location at src/core/error_handler
...
def cli(
    ...
    """
    if version:
        console.print(f"Claude-TUI version {__version__}", style="bold green")
        sys.exit(0)
...
def main() -> None:
    """
    Main entry point for the claude-tui application.
