./claude-flow hive-mind spawn "Du bist die led queen. spawne dir ein mittelgroßes Team. 
...
In der .env findest du folgende Variablen:
-für die AI Features (auch zum testen), der OAUTH Token für claude code in Variable: CLAUDE_CODE_OAUTH_TOKEN
